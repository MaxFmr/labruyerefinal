    ...
    <>
      ...
      <div style={{ margin: '10%', textAlign: 'justify', color: '#257676' }}>
        <p>
          ...
          site internet https://www.latabledelabruyere.com sont :
        </p>
        <strong> Éditeur du Site :</strong>
        <p>La Table de La Bruyère</p>
        ...
        Firefox, Google Chrome, etc… L’agence web, met en œuvre tous les moyens
        dont elle dispose, pour assurer une information fiable et une mise à
        jour fiable de ses sites internet. Toutefois, des erreurs ou omissions
        peuvent survenir. L’internaute devra donc s’assurer de l’exactitude des
        informations auprès de La Table de la Bruyère , et signaler toutes
        modifications du site qu’il jugerait utile. La Table de la Bruyère n’est
        en aucun cas responsable de l’utilisation faite de ces informations, et
        de tout préjudice direct ou indirect pouvant en découler. Cookies : Le
        site 
        {process.env.domain} peut-être amené à vous demander l’acceptation des
        ...
        peuvent être fonctionnelles sans l’acceptation de cookies. Liens
        hypertextes : Les sites internet de peuvent offrir des liens vers
        d’autres sites internet ou d’autres ressources disponibles sur
        Internet.La Table de la Bruyère ne dispose d’aucun moyen pour contrôler
        les sites en connexion avec ses sites internet. La Table de la Bruyère
        ne répond pas de la disponibilité de tels sites et sources externes, ni
        ne la garantit. Il ne peut être tenue pour responsable de tout dommage,
        de quelque nature que ce soit, résultant du contenu de ces sites ou
        ...
        l’autorisation expresse et préalable de La Table de la Bruyère. Dans
        l’hypothèse où un utilisateur ou visiteur souhaiterait mettre en place
        un hyperlien en direction d’un des sites internet de Le réveil de la
        Bruyère., il lui appartiendra d’adresser un email accessible sur le site
        afin de formuler sa demande de mise en place d’un hyperlien. La Table de
        la Bruyère. se réserve le droit d’accepter ou de refuser un hyperlien
        sans avoir à en justifier sa décision.
        <h2>Services fournis</h2>
        L’ensemble des activités de La Table de la Bruyère ainsi que ses
        informations sont présentés sur notre {process.env.doamin}. La table de
        la bruyère s’efforce de fournir sur le site {process.env.domain}des
        informations aussi précises que possible. Les renseignements figurant
        sur le site
        {process.env.domain}
        ...
        {process.env.domain} sont données à titre indicatif, et sont
        susceptibles de changer ou d’évoluer sans préavis. Limitation
        contractuelles sur les données : Les informations contenues sur ce site
        sont aussi précises que possible et le site remis à jour à différentes
        périodes de l’année, mais peut toutefois contenir des inexactitudes ou
        des omissions. Si vous constatez une lacune, erreur ou ce qui parait
        être un dysfonctionnement, merci de bien vouloir le signaler par
        courriel, à l’adresse maxime.kerlidou@gmail.com, en décrivant le
        problème de la manière la plus précise possible (page posant problème,
        type d’ordinateur et de navigateur utilisé, …). Tout contenu téléchargé
        ...
        dernière génération mis-à-jour. Les liens hypertextes mis en place dans
        le cadre du présent site internet en direction d’autres ressources
        présentes sur le réseau Internet ne sauraient engager la responsabilité
        de La Table de la Bruyère.
        <h2>Propriété intellectuelle :</h2>
        <p>
          Tout le contenu du présent site {process.env.domain} incluant, de
          ...
          La Table de la Bruyère. Cette représentation ou reproduction, par
        ...
        {process.env.domain}. Cependant, ce principe comporte certaines
        ...
        : votre nom, votre fonction, le nom de votre société, votre adresse
        ...
        « contact ». Dans tous les cas, vous pouvez refuser de fournir vos
        données personnelles. Dans ce cas, vous ne pourrez pas utiliser les
        services du site, notamment celui de solliciter des renseignements sur
        notre société, ou de recevoir les lettres d’information. Enfin, nous
        ...
        votre adresse IP, le type de votre navigateur, vos temps d’accès. De
